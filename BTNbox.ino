...
void setup() {
    ...
    box.addEncoder(ENCODER1_CLK, ENCODER1_DT, ENCODER1_SW, new VolumeControl());
    
    // Configura encoder per controlli multimediali
    box.addEncoder(ENCODER2_CLK, ENCODER2_DT, ENCODER2_SW, new MediaControl());
    
    // Configura encoder custom con F13-F15
    box.addEncoder(ENCODER3_CLK, ENCODER3_DT, ENCODER3_SW, new CustomEncoder1());
    
    // Configura encoder custom con F16-F18
    box.addEncoder(ENCODER4_CLK, ENCODER4_DT, ENCODER4_SW, new CustomEncoder2());
}
